DROP VIEW IF EXISTS AV_Enterprise;

CREATE VIEW AV_Enterprise
AS
SELECT 
     e.EnterpriseId
    ,e.RegistDate
    ...
    ,ae.N_IncludeMonthlyFee
    ,ae.N_ApiMonthlyFee
    ,ae.N_CreditNoticeMonthlyFee
    ,ae.N_NCreditNoticeMonthlyFee
    ,ae.N_ReserveMonthlyFee
    ,ae.OemIncludeMonthlyFee
    ,ae.OemApiMonthlyFee
    ,ae.OemCreditNoticeMonthlyFee
    ,ae.OemNCreditNoticeMonthlyFee
    ,ae.OemReserveMonthlyFee
    ,ae.N_OemIncludeMonthlyFee
    ,ae.N_OemApiMonthlyFee
    ,ae.N_OemCreditNoticeMonthlyFee
    ,ae.N_OemNCreditNoticeMonthlyFee
    ,ae.N_OemReserveMonthlyFee
FROM T_Enterprise e
    ,AT_Enterprise ae
WHERE e.EnterpriseId = ae.EnterpriseId;
