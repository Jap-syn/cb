DROP procedure IF EXISTS `procMigrateDeliveryDestinationB`;

DELIMITER $$
CREATE PROCEDURE `procMigrateDeliveryDestinationB` ()
BEGIN
    ...
    WHERE  `T_DeliveryDestination`.`DeliDestId` > 8999999;
END
$$
