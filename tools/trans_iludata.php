...
$this->logger->info('trans_iludata.php start');
...
$this->logger->info('trans_iludata.php end');
$this->logger->info(sprintf('trans_iludata.php elapsed time = %s', (microtime(true) - $start)));
