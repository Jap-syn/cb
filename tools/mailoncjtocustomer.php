...
$this->logger->info('mailoncjtocustomer.php start');
            ...
            // システムステータス
            $mdlss = new TableSystemStatus($this->dbAdapter);
            $lockId = $mdlss->getCjMailLock();
...
$this->logger->info('mailoncjtocustomer.php end');
            $exitCode = 0; // 正常終了
