...
$this->logger->info('trans_iludata_04.php start');
	   ...
	   //20160221-sode ソース分割の対応
	    $this->receipt_no  = self::$_argv [1];
	    echo self::$_argv [1];

            // 審査システムデータ移行処理
            $this->_exec();

$this->logger->info('trans_iludata_04.php end');
$this->logger->info(sprintf('trans_iludata_04.php elapsed time = %s', (microtime(true) - $start)));
