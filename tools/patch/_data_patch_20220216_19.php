...
class Application extends BaseApplicationAbstract {
    ...
    public function run() {
        ...
        try {
            ...
            $this->logger->info('_data_patch_20220216_19.php start');
            ...
            $this->logger->info('_data_patch_20220216_19.php end');
            $exitCode = 0; // 正常終了
        } catch( \Exception $e ) {
            try{
    ...
    public function _exec()
    {
        ...
        foreach ($ri as $row) {
            ...
            $prm_base_has_extra = array(':PhysicalName' => 'ReceiptProcessDate', ':TemplateSeq' => $row['TemplateSeq']);
            ...
            $prm = array(
                ...
                ':PhysicalName' => 'ReceiptProcessDate',
                ':LogicalName' => '入金確認日',
                ':FieldClass' => 'DATE',
                ':RequiredFlg' => 0,
                ':DefaultValue' => null,
