...
class Application extends BaseApplicationAbstract {
    ...
    public function run() {
        ...
        try {
            ...
            $this->logger->info('_data_patch_20220216_18.php start');
            ...
            $this->logger->info('_data_patch_20220216_18.php end');
            $exitCode = 0; // 正常終了
        } catch( \Exception $e ) {
            try{
    ...
    public function _exec()
    {
        ...
        foreach ($ri as $row) {
            ...
            $prm_base_has_extra = array(':PhysicalName' => 'ReceiptClass', ':TemplateSeq' => $row['TemplateSeq']);
