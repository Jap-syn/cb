...
/**
 * アプリケーションクラスです。
 * 指定の振込データを作成するバッチ(2015-12-31締め、2016-01-15立替分)
 *
 */
...
$this->logger->info('_data_patch_20160108_2200.php start');
...
$this->logger->info('_data_patch_20160108_2200.php end');
            $exitCode = 0; // 正常終了
...
AND     pc.FixedDate IN ('2015-12-31')
...
//         $sql .= "               AND    PC.ExecFlg = " . $isExec;
        ...
        $sql .= ("          AND    PC.FixedDate IN( '2015-12-31') ");
