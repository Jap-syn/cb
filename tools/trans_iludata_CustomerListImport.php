...
$this->logger->info('trans_iludata_03.php start');
...
$this->logger->info('trans_iludata_03.php end');
$this->logger->info(sprintf('trans_iludata_03.php elapsed time = %s', (microtime(true) - $start)));
