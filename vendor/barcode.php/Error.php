<?php 
{
	...
	/// </summary>
	class errCode39BadChar extends Exception
	{
		public errCode39BadChar(string s)
			:	base("Pao.BarCode.Code39 : 利用できない文字 = '" + s + "' が使用されました。\n" 
			+ "使用できる文字は\"1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ-. *$/+%\"です。"){}
		public errCode39BadChar(Exception innerException, string s)
			:	base("Pao.BarCode.Code39 : 利用できない文字 = '" + s + "' が使用されました。\n" 
			+ "使用できる文字は\"1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ-. *$/+%\"です。",innerException){}
	}
