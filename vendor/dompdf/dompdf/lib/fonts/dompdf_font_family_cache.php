<?php return array (
  ...
  'migu-1m-regular' => 
  array (
    'normal' => DOMPDF_FONT_DIR . 'migu-1m-regular',
    'bold' => DOMPDF_FONT_DIR . 'migu-1m-regular',
    'italic' => DOMPDF_FONT_DIR . 'migu-1m-regular',
    'bold_italic' => DOMPDF_FONT_DIR . 'migu-1m-regular',
  ),
  'migu-1m-bold' => 
  array (
    'normal' => DOMPDF_FONT_DIR . 'migu-1m-bold',
    'bold' => DOMPDF_FONT_DIR . 'migu-1m-bold',
    'italic' => DOMPDF_FONT_DIR . 'migu-1m-bold',
    'bold_italic' => DOMPDF_FONT_DIR . 'migu-1m-bold',
  ),
  'migu-1p-regular' => 
  array (
    'normal' => DOMPDF_FONT_DIR . 'migu-1p-regular',
    'bold' => DOMPDF_FONT_DIR . 'migu-1p-regular',
    'italic' => DOMPDF_FONT_DIR . 'migu-1p-regular',
    'bold_italic' => DOMPDF_FONT_DIR . 'migu-1p-regular',
  ),
  'migu-1p-bold' => 
  array (
    'normal' => DOMPDF_FONT_DIR . 'migu-1p-bold',
    'bold' => DOMPDF_FONT_DIR . 'migu-1p-bold',
    'italic' => DOMPDF_FONT_DIR . 'migu-1p-bold',
    'bold_italic' => DOMPDF_FONT_DIR . 'migu-1p-bold',
  ),
  'ocra' => 
  array (
    'normal' => DOMPDF_FONT_DIR . 'OCRA',
    'bold' => DOMPDF_FONT_DIR . 'OCRA',
    'italic' => DOMPDF_FONT_DIR . 'OCRA',
    'bold_italic' => DOMPDF_FONT_DIR . 'OCRA',
  ),
  'ocrb' => 
  array (
    'normal' => DOMPDF_FONT_DIR . 'OCRB',
    'bold' => DOMPDF_FONT_DIR . 'OCRB',
    'italic' => DOMPDF_FONT_DIR . 'OCRB',
    'bold_italic' => DOMPDF_FONT_DIR . 'OCRB',
  ),
) ?>