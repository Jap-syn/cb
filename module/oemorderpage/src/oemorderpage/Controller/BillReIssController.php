    ...
    */
    protected function _init() {
        ...
        if ($this->is_mobile_request()) {
            $this->addStyleSheet( '../../oemorderpage/css_sp/orderpage_billreiss.css')
                 ->addStyleSheet( '../../oemorderpage/css_sp/orderpage_index.css' );
        } else {
            $this->addStyleSheet( '../../oemorderpage/css/orderpage_billreiss.css')
                 ->addStyleSheet( '../../oemorderpage/css/orderpage_index.css' );
        }
...
EOQ;
        ...
        $oemId = ( empty( $this->userInfo->OemId ) ) ? 0 : $this->userInfo->OemId;
