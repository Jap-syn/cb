...
/**
 * T_SkipDeleteList(スキップ対象者削除リスト)テーブルへのアダプタ
 */
class TableSkipDeleteList
{
    protected $_name = 'T_SkipDeleteList';
    ...
    {
        $sql = " SELECT * FROM T_SkipDeleteList WHERE ManCustId = :ManCustId ";
    ...
    {
        $sql  = " INSERT INTO T_SkipDeleteList (ManCustId, RegNameKj, RegUnitingAddress, RegPhone, MailAddress, LastReceiptDate, LastClaimDate, RegistDate, RegistId, UpdateDate, UpdateId, ValidFlg) VALUES (";
        $sql .= "   :ManCustId ";
        $sql .= " , :RegNameKj ";
