...
/**
 * 連続する全角マイナス記号を1文字に切り詰める正規化フィルタ
 */
class LogicNormalizerHyphenCompaction extends LogicNormalizerAbstract {
    /**
     * LogicNormalizerHyphenCompactionの新しいインスタンスを
     * 初期化する
     */
	 ...
	 * LogicNormalizerHyphenCompactionでは、連続する全角マイナスを
	 * 1文字に統合する
	 *
	 * @access protected
