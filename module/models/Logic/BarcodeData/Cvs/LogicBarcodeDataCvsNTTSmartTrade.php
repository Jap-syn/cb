...
/**
 * NTTスマートトレード入金用バーコードデータ生成クラス
 */
class LogicBarcodeDataCvsNTTSmartTrade extends LogicBarcodeDataCvsAbstract {
	/**
	 * メーカーコードを指定してLogicBarcodeDataCvsNTTSmartTradeの新しいインスタンスを
	 * 初期化する
	 *
