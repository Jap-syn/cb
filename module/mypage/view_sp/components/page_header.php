...
<!-- Header start -->
<div id="header">
  <!-- <div id="titleimg"><img src="../images/Atobarai_logo.gif" alt="後払いドットコム" width="110" height="20" /></div> -->
  <div id="titleimg"><img src="../images/logo_ato_todo_color.png" alt="届いてから払い" width="110" height="20" /></div>
