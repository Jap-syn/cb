...
$this->currentOemInfo = $oem_info = Application::getInstance()->getCurrentOemData();
...
<head>
    ...
    <link rel="stylesheet" href="../../oemmypage/css_sp/<?php echo f_e($css); ?>" />
...
<?php } ?>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-177563793-10"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-177563793-10');
    </script>
