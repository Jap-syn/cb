 ...
 * JNB手動入金コントローラ
 */
class JnbrcptController extends CoralControllerAction {
	 ...
	 *
	 * @access protected
	 * @var LogicJnbAccountReceiptManual
	 */
	protected $_logic;
	...
	protected function _init()
	{
        ...
        $this->setPageTitle('後払い.com - JNB手動入金処理');

        $this->view->assign('current_action', $this->getActionName());
        $this->view->assign('userInfo', $this->app->authManagerAdmin->getUserInfo());
        $this->_logic = new LogicJnbAccountReceiptManual($this->app->dbAdapter);
	...
	public function execAction()
	{
        ...
        //リダイレクト
        return $this->_redirect( "jnbrcpt/index" );
	}
	...
	public function disposeAction()
	{
        ...
        try{
            ...
            try {
                //手動不能処理
                $this->_logic->doneUnreceipt($nfSeq, LogicJnbAccountReceiptManual::RESULT_TYPE_8_DISPOSE_NOTIFY, $data['OrderSeq'], $data['AccountSeq']);
                $this->app->dbAdapter->getDriver()->getConnection()->commit();
            }
            catch(\Exception $err) {
                $this->app->dbAdapter->getDriver()->getConnection()->rollBack();
