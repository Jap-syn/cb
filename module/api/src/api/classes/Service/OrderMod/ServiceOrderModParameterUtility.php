<?php
require_once 'Service/Modify/Const.php';

/**
 * 注文修正APIのリクエストパラメータを整形するユーティリティ
 */
class Service_Modify_ParameterUtility {
    /**
    ...
    /**
     * Service_Modify_ParameterUtilityの新しいインスタンスを初期化する
     */
    ...
    public function parseAll(array $params = array()) {
        return array(
            Service_Modify_Const::GROUP_ORDER => $this->parseOrderGroup($params),
            Service_Modify_Const::GROUP_CUSTOMER => $this->parseCustomerGroup($params),
            Service_Modify_Const::GROUP_DESTINATION => $this->parseDestinationGroup($params),
            Service_Modify_Const::GROUP_JOURNAL => $this->parseJournalGroup($params),
            Service_Modify_Const::GROUP_ITEMS => $this->parseItemsGroup($params)
        );
    }
