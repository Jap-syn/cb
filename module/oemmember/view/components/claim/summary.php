	...
	<table class="claim_result charge_list_table summary_table" border="1" cellpadding="0" cellspacing="0">
		<tbody>
            ...
            <tr class="summary fat_border">
				...
				<td class="date_col total_col summary_value_col"><?php echo $p['FixedExecDate']; ?></td>
			</tr>
        ...
        <?php } ?>
			<tr class="summary fat_border">
				...
				<td class="money_col total_col summary_value_col"><?php echo nvl(f_nf($p['ChargeAmount'], '\ #,##0'), '\ 0'); ?></td>
			</tr>
			<?php if ($p['ChargeCountExtraPay1DK'] > 0 || $p['ChargeCountExtraPay1BS'] > 0 ) { ?>
            <tr class="summary">
		...
		<?php } ?>
			...
			<tr class="summary">
				...
				<td class="money_col total_col summary_value_col"><?php echo nvl(f_nf(-1 * (int)$p['StampFeeTotal'], '\ #,##0'), '\ 0'); ?></td>
			</tr>
			<tr class="summary">
			...
			<tr class="summary">
				...
				<td class="money_col total_col summary_value_col"><?php echo nvl(f_nf($p['CarryOver'], '\ #,##0'), '\ 0'); ?></td>
			</tr>
			<tr class="summary">
			...
			<tr class="summary fat_border">
				...
				<td class="money_col total_col summary_value_col"><?php echo nvl(f_nf(-1 * (int)$p['TransferCommission'], '\ #,##0'), '\ 0'); ?></td>
			</tr>
<?php if (false) { ?>
