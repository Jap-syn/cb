...
$this->render('oemmember/common_assign.php');
?>
...
<head>
	...
	<base href="<?php echo f_e($this->baseUrl); ?>/" />
	<title><?php echo f_e($page_title_prefix . $this->pageTitle); ?></title>
<?php foreach( $this->styleSheets as $path ) { ?>
	<link rel="styleSheet" href="<?php echo f_e($path); ?>" />
<?php } ?>
<!-- 	<link rel="stylesheet" href="resource/css" />  -->
    <link rel="stylesheet" href="<?php echo f_e($css); ?>" />
...
<?php foreach( $this->javaScripts as $path ) { ?>
	<script src="<?php echo f_e($path); ?>"></script>
<?php } ?>
	<script>
