...
EOQ;
        ...
        $success_url = $mdlsp->getValue(\models\Table\TableSystemProperty::DEFAULT_MODULE, 'sbpspayment', 'success_url');
        $success_url = str_replace('www3.atobarai-dev.jp', $_SERVER['SERVER_NAME'], $success_url);
        $success_url = str_replace('cb.atobarai-dev.jp', $_SERVER['SERVER_NAME'], $success_url);
        $success_url = str_replace('cb.atobarai.jp', $_SERVER['SERVER_NAME'], $success_url);
        $cancel_url = $mdlsp->getValue(\models\Table\TableSystemProperty::DEFAULT_MODULE, 'sbpspayment', 'cancel_url');
        $cancel_url = str_replace('www3.atobarai-dev.jp', $_SERVER['SERVER_NAME'], $cancel_url);
        $cancel_url = str_replace('cb.atobarai-dev.jp', $_SERVER['SERVER_NAME'], $cancel_url);
        $cancel_url = str_replace('cb.atobarai.jp', $_SERVER['SERVER_NAME'], $cancel_url);
        $error_url = $mdlsp->getValue(\models\Table\TableSystemProperty::DEFAULT_MODULE, 'sbpspayment', 'error_url');
        $error_url = str_replace('www3.atobarai-dev.jp', $_SERVER['SERVER_NAME'], $error_url);
        $error_url = str_replace('cb.atobarai-dev.jp', $_SERVER['SERVER_NAME'], $error_url);
        $error_url = str_replace('cb.atobarai.jp', $_SERVER['SERVER_NAME'], $error_url);
        $pagecon_url = $mdlsp->getValue(\models\Table\TableSystemProperty::DEFAULT_MODULE, 'sbpspayment', 'pagecon_url');
        $pagecon_url = str_replace('www3.atobarai-dev.jp', $_SERVER['SERVER_NAME'], $pagecon_url);
        $pagecon_url = str_replace('cb.atobarai-dev.jp', $_SERVER['SERVER_NAME'], $pagecon_url);
        $pagecon_url = str_replace('cb.atobarai.jp', $_SERVER['SERVER_NAME'], $pagecon_url);
        ...
        $this->view->assign( 'purchase_url', $mdlsp->getValue(\models\Table\TableSystemProperty::DEFAULT_MODULE, 'sbpspayment', 'purchase_url') );
        return $this->view;
    }
