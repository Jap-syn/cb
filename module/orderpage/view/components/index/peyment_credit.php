    <div id="d_01" style="background-color: #F0F0F0; width: 570px">
            <table width="570" cellpadding="1" cellspacing="1" border="0" style="margin: 0px; padding: 0px; background-color: #F0F0F0;">
                <tbody>
                    <tr id="lbl_03">
...
<div id="d_01" style="background-color: #F0F0F0; width: 570px">
            <table width="570" cellpadding="1" cellspacing="1" border="0" style="margin: 0px; padding: 0px; background-color: #F0F0F0;">
                <tbody>
                    ...
                    <tr>
                        <td class="tb_08"></td>
<?php if ($order['AppMaxNumUseDay'] == 999) { ?>
                    	<td class="tb_07" colspan="3">
    ...
    <div id="d_01" style="background-color: #F0F0F0; width: 570px">
            <table width="570" cellpadding="1" cellspacing="1" border="0" style="margin: 0px; padding: 0px; background-color: #F0F0F0;">
                <tbody>
                    ...
                    <tr>
                        <td class="tb_08"></td>
                        <td class="tb_07" style="font-size: 13px;">最寄りのコンビニ店頭レジ、及び 以下のアプリ請求書払いよりお支払いいただけます。</td>
                        <td class="tb_06"></td>
                        <td class="tb_08"></td>
                    </tr>
                    <tr>
    ...
    <div id="d_01" style="background-color: #F0F0F0; width: 570px">
            <table width="570" cellpadding="1" cellspacing="1" border="0" style="margin: 0px; padding: 0px; background-color: #F0F0F0;">
                <tbody>
                    ...
                    <tr>
                        <td class="tb_08"></td>
                        <td class="tb_07" style="font-size: 13px;">最寄りのゆうちょ銀行・郵便局よりお振込みいただけます。</td>
                        <td class="tb_06"></td>
                        <td class="tb_08"></td>
                    </tr>
                </tbody>
    ...
    <div id="d_01" style="background-color: #F0F0F0; width: 570px">
            <table width="570" cellpadding="1" cellspacing="1" border="0" style="margin: 0px; padding: 0px; background-color: #F0F0F0;">
                <tbody>
                    ...
                    <tr>
                        <td class="tb_08"></td>
                        <td class="tb_07" style="font-size: 13px;">銀行窓口・ATM・ネットバンクにてお支払いいただけます。</td>
                        <td class="tb_06"></td>
                        <td class="tb_08"></td>
                    </tr>
                </tbody>
