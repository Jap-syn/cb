...
class ClaimController extends CoralControllerAction {
	...
	protected function _init()
	{
        ...
        $this->addStyleSheet( './css/members.css' )
            ...
            ->addStyleSheet( './css/tab_support.css' )
            ->addStyleSheet( './css/claim.css' )
            ->addStyleSheet( './css/monthly.css' )   /* confirmNews対応(20150401_1330) */
	...
	public function indexAction()
	{
        ...
        // ①請求書兼領収書：member/claim/summary.php
        $sql = <<<Q_END
...
Q_END;
        ...
        // ②お取引明細：member/claim/charge_list.php
...
Q_END;
        ...
        // ③印紙代明細：member/claim/stamp_list.php
        // StampFeeはそのまま値で取得する
        $sql = <<<Q_END
SELECT s.SiteId
,      s.SiteNameKj
...
Q_END;
        ...
        // ④キャンセル返金明細：member/claim/cancel_list.php
        $sql = <<<Q_END
SELECT s.SiteId
,      s.SiteNameKj
,      '' AS No
...
Q_END;
        ...
        // ⑤調整額内訳明細：member/claim/adjustment_list.php
        $sql = <<<Q_END
SELECT '' AS No
,      pc2.FixedDate
,      aa.OrderId
...
//         // ⑥立替精算戻し明細：member/claim/payback_list.list
//         $sql = <<<Q_END
// SELECT s.SiteId
// ,      s.SiteNameKj
// ,      '' AS No
