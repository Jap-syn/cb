...
class OrderInputInfo {
	 ...
	 * T_OrderItemsに関するフォームフィールドグループを指定するキー
	 */
	const ARRKEY_ORDERADDINFO = 'order_addinfo';

	const REGEXP_DATETIME = '/^\d{4}\/\d{2}\/\d{2}$/';

	public static function createFormManager(array $validationMap = array() , int $creditTransferFlg = 0, $billingAgentFlg = 0) {
		...
		$result
			...
			->addItem( self::ARRKEY_CUSTO, new CoralFormItem( array(
				...
				CoralFormItem::VALIDATION	=> nvl($validationMap['T_Customer.NameKn'], '/^.{0,30}$/'),
				CoralFormItem::ATTRIBUTES	=> array(
					'size'	=> 30
				)
			) ) )
			...
			->addItem( self::ARRKEY_CUSTO, new CoralFormItem( array(
				...
				CoralFormItem::VALIDATION	=> CoralValidateUtility::EMAIL_ADDRESS,
				CoralFormItem::ATTRIBUTES	=> array(
					'size'	=> 40,
					'class'	=> 'must'
				)
       	...
       	if ($billingAgentFlg == 1) {
    		$result
    		    ->createGroup( self::ARRKEY_ORDERADDINFO, '自由入力情報', '⇒請求書の自由入力欄に表示されます。' )
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free1',
    				CoralFormItem::ID			=> 'Free1',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free1',
    				CoralFormItem::CAPTION		=> '１行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    				)
    			) ) )
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free2',
    				CoralFormItem::ID			=> 'Free2',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free2',
    				CoralFormItem::CAPTION		=> '２行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free3',
    				CoralFormItem::ID			=> 'Free3',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free3',
    				CoralFormItem::CAPTION		=> '３行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free4',
    				CoralFormItem::ID			=> 'Free4',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free4',
    				CoralFormItem::CAPTION		=> '４行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free5',
    				CoralFormItem::ID			=> 'Free5',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free5',
    				CoralFormItem::CAPTION		=> '５行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free6',
    				CoralFormItem::ID			=> 'Free6',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free6',
    				CoralFormItem::CAPTION		=> '６行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free7',
    				CoralFormItem::ID			=> 'Free7',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free7',
    				CoralFormItem::CAPTION		=> '７行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free8',
    				CoralFormItem::ID			=> 'Free8',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free8',
    				CoralFormItem::CAPTION		=> '８行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free9',
    				CoralFormItem::ID			=> 'Free9',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free9',
    				CoralFormItem::CAPTION		=> '９行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free10',
    				CoralFormItem::ID			=> 'Free10',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free10',
    				CoralFormItem::CAPTION		=> '１０行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free11',
    				CoralFormItem::ID			=> 'Free11',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free11',
    				CoralFormItem::CAPTION		=> '１１行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free12',
    				CoralFormItem::ID			=> 'Free12',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free12',
    				CoralFormItem::CAPTION		=> '１２行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free13',
    				CoralFormItem::ID			=> 'Free13',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free13',
    				CoralFormItem::CAPTION		=> '１３行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free14',
    				CoralFormItem::ID			=> 'Free14',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free14',
    				CoralFormItem::CAPTION		=> '１４行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free15',
    				CoralFormItem::ID			=> 'Free15',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free15',
    				CoralFormItem::CAPTION		=> '１５行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free16',
    				CoralFormItem::ID			=> 'Free16',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free16',
    				CoralFormItem::CAPTION		=> '１６行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free17',
    				CoralFormItem::ID			=> 'Free17',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free17',
    				CoralFormItem::CAPTION		=> '１７行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free18',
    				CoralFormItem::ID			=> 'Free18',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free18',
    				CoralFormItem::CAPTION		=> '１８行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free19',
    				CoralFormItem::ID			=> 'Free19',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free19',
    				CoralFormItem::CAPTION		=> '１９行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
    			...
    			->addItem( self::ARRKEY_ORDERADDINFO, new CoralFormItem( array(
    				CoralFormItem::TYPE			=> CoralFormItem::TYPE_TEXT,
    				CoralFormItem::NAME			=> 'Free20',
    				CoralFormItem::ID			=> 'Free20',
    				CoralFormItem::COLUMN_MAP	=> 'T_OrderAddInfo.Free20',
    				CoralFormItem::CAPTION		=> '２０行目',
    				CoralFormItem::DESCRIPTION	=> '任意でご入力ください。最大半角60文字。',
    				CoralFormItem::VALIDATION	=> '/^.{0,60}$/',
    				CoralFormItem::ATTRIBUTES	=> array(
    					'size'	=> 65,
