...
<?php	foreach($rows as $row) { ?>
			<tr>
				...
				<td class="date_col col_6"><?php echo is_null($row['FixedDate']) ? "&nbsp;" : f_dfx($row['FixedDate'], 'y/m/d'); ?></td>
				<td class="date_col col_7"><?php echo f_dfx($row['CancelDate'], 'y/m/d'); ?></td>
				<td class="money_col col_8"><?php echo nvl(f_nfx($row['UseAmount'], '\ #,##0'), '&nbsp;'); ?></td>
