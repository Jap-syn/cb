...
// DatePickerクラス
base.UI.DatePicker = Class.create();
// 定数およびスタティックプロパティの定義
Object.extend( base.UI.DatePicker, {
	...
	__initialize : function() {
		if( base.UI.DatePicker.__initialized ) return;
		base.UI.DatePicker.__initialized = true;
		base.UI.DatePicker._elementTemplate = (function() {
			var buf = [
				...
				"<tr>",
				[
					{ c : this.classNames.prevYear, t : "&nbsp;" },
					{ c : this.classNames.prevMonth, t : "&nbsp;" },
					{ c : this.classNames.titleCell, t : "" },
					{ c : this.classNames.nextMonth, t : "&nbsp;" },
					{ c : this.classNames.nextYear, t : "&nbsp;" }
				].map( function(prop) {
					return "<td class=\"{0}\">{1}</td>".format( prop.c, prop.t );
				} ).join(""),
				"</tr>",
				"</tbody>",
				"</table>",
...
base.UI.DatePicker.prototype = {
	...
	show : function(evt) {
		...
		if( target && ! target.disabled ) {
			base.UI.DatePicker.requirePopup( this );
			this.setPosition();
